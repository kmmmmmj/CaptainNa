...
public interface NetworkService {
    ...
    Call<MakeEventResult> registerEvent(@Header("token") String token,
                                        ...
                                        @Field("place") RequestBody place,
                                        @Field("amount") RequestBody amount,
                                        @Field("start_date") RequestBody start_date,
                                        @Field("end_date") RequestBody end_date,
                                        @Field("manager_name") RequestBody manager_name,
                                        @Field("place_1st") RequestBody place_1st,
                                        @Field("amount_1st") RequestBody amount_1st,
                                        @Field("place_2nd") RequestBody place_2nd,
                                        @Field("amount_2nd") RequestBody amount_2nd,
                                        @Field("place_3rd") RequestBody place_3rd,
                                        @Field("amount_3rd") RequestBody amount_3rd,
                                        @Part MultipartBody.Part photo);
