...
MakeEventActivity extends AppCompatActivity {
    ...
    private void regsiterEvent() {
        ...
        RequestBody amount= RequestBody.create(MediaType.parse("multipart/form-data"), etEventMoney.getText().toString());
        ...
        RequestBody place_2nd= RequestBody.create(MediaType.parse("multipart/form-data"), etSecondPartyMoney.getText().toString());
        ...
        RequestBody start_date= RequestBody.create(MediaType.parse("multipart/form-data"), "2017-04-04");
        RequestBody end_date = RequestBody.create(MediaType.parse("multipart/form-data"), "2017-09-09");
        RequestBody manager_name = RequestBody.create(MediaType.parse("multipart/form-data"), "라라라");



        Call<MakeEventResult> request = service.registerEvent(token, group_id, title, text, place, amount,
                start_date, end_date, manager_name, place_1st, amount_1st, place_2nd, amount_2nd, place_3rd, amount_3rd, null);
